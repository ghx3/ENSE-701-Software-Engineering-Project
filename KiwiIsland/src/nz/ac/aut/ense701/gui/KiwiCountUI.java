    ...
    implements GameEventListener
{
    ...
    {
       //add key to the game frame	
       game.addGameEventListener(this); 
       //try to make the key work
       this.addKeyListener(new KeyListener(){
    	   @Override
    		...
    		public void keyPressed(KeyEvent e) {
    			// to move the player by using keyboard 
    			  
    			 if (game.isPlayerMovePossible(MoveDirection.NORTH) && e.getKeyCode() == KeyEvent.VK_W || e.getKeyCode() == KeyEvent.VK_UP) {
    		            game.playerMove(MoveDirection.NORTH);
    		        }
    		        if (game.isPlayerMovePossible(MoveDirection.SOUTH)&& e.getKeyCode() == KeyEvent.VK_S || e.getKeyCode() == KeyEvent.VK_DOWN) {
    		            game.playerMove(MoveDirection.SOUTH);
    		        }
    		        if (game.isPlayerMovePossible(MoveDirection.WEST) && e.getKeyCode() == KeyEvent.VK_A || e.getKeyCode() == KeyEvent.VK_LEFT ) {
    		            game.playerMove(MoveDirection.WEST);
    		        }
    		        if (game.isPlayerMovePossible(MoveDirection.EAST) && e.getKeyCode() == KeyEvent.VK_D || e.getKeyCode() == KeyEvent.VK_RIGHT) {
